...
class CniirIndexService
{
    ...
    public static function saveCniirIndex($org_id, $quadrant_id, $user_id, $score, $pre_event_rtd_score, $during_event_rtd_score, $post_event_rtd_score, $identify, $protect, $detect, $respond, $recover){
